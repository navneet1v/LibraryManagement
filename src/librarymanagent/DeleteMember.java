...
public class DeleteMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete a Memeber");
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        if(!pass.equals(ADMIN_PASSWORD)){
            ...
            if(m.deleteMember())
            {
                JOptionPane.showMessageDialog(null,"Sucessful Deleted the Member", "Member Deletd",JOptionPane.INFORMATION_MESSAGE);
            }else{
                JOptionPane.showMessageDialog(null,"May be this member is arlready Deletd or not present", "Member Not Found",JOptionPane.INFORMATION_MESSAGE);
            }
